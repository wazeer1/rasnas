...
export default function CartButton() {
  ...
  return (
    ...
    >
      <CartIcon />
      <span className="cart-counter-badge flex items-center justify-center bg-black text-white absolute -top-2.5 xl:-top-3 rounded-full ltr:-right-2.5 ltr:xl:-right-3 rtl:-left-2.5 rtl:xl:-left-3 font-bold">
        {totalItems}
      </span>
    </button>
  );
