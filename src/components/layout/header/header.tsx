...
const Header: React.FC = () => {
  ...
  const handleCountrySwitch = (country: string) => {
    ...
    // Perform any additional actions when the country changes
  };
  ...
  return (
    ...
    >
      <div className="fixed z-20 w-full h-16 px-4 text-gray-700 transition duration-200 ease-in-out bg-body innerSticky body-font sm:h-20 lg:h-24 md:px-8 lg:px-6">
